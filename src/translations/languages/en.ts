...
export const en: Translations = {
    ...
    howToBuyStep1Title: '1. Set Up Your Wallet',
    howToBuyStep1Content: 'You\'ll need a crypto wallet to store your $FEPE presale tokens. We recommend MetaMask, which allows you to easily manage your tokens and track your balance after purchase.',
    howToBuyStep2Title: '2. Fund Your Wallet',
    howToBuyStep2Content: 'Deposit ETH, BNB, or USDT into your wallet using any exchange of your choice. If you\'re purchasing with a credit/debit card, you can skip this step—but you\'ll still need a wallet to receive your tokens.',
    howToBuyStep3Title: '3. Stake Your $FEPE',
    howToBuyStep3Content: 'Exclusive to presale buyers, staking lets you earn rewards before the token hits the market. Get in early and enjoy dynamic APY, maximizing your returns before trading goes live.',
